...
Expected: [Function toUpperCase]
Received: "ENTER ACCOUNT INFORMATION"
```
      ...
      - generic [ref=e43]:
        ...
        - generic [ref=e54]:
          - generic [ref=e55]:
            - text: Name
            - superscript [ref=e56]: "*"
          - textbox "Name *" [ref=e57]: User1781414296002
        - generic [ref=e58]:
          - generic [ref=e59]:
            - text: Email
            - superscript [ref=e60]: "*"
          - textbox "Email *" [disabled] [ref=e61]: user1781414296002@gmail.com
        - generic [ref=e62]:
          - generic [ref=e63]:
            - text: Password
            - superscript [ref=e64]: "*"
...
> 10 | expect (await signupPage.getHeading()).toBe("Enter Account Information".toUpperCase);
     |                                        ^ Error: expect(received).toBe(expected) // Object.is equality
