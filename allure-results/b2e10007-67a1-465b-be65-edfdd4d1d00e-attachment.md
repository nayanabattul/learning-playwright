    ...
    - generic [ref=e43]:
      ...
      - generic [ref=e54]:
        - generic [ref=e55]:
          - text: Name
          - superscript [ref=e56]: "*"
        - textbox "Name *" [ref=e57]: User1781413800508
      - generic [ref=e58]:
        - generic [ref=e59]:
          - text: Email
          - superscript [ref=e60]: "*"
        - textbox "Email *" [disabled] [ref=e61]: user1781413800508@gmail.com
      - generic [ref=e62]:
        - generic [ref=e63]:
          - text: Password
          - superscript [ref=e64]: "*"
...
> 10 | expect (signupPage.getHeading).toBe("Enter Account Information");
     |                                ^ Error: expect(received).toBe(expected) // Object.is equality
  11 | await signupPage.checkFRadio;
  12 | await signupPage.enterPassword(setPassword());
  13 | await signupPage.selectDDday();
  14 | await signupPage.selectDDmonth();
  15 | await signupPage.selectDDyear();
  16 | await signupPage.checkNewsletter();
  17 | await signupPage.checkOption();
  18 | await signupPage.enterFName("Nayana");
  19 | await signupPage.enterLName("Battul");
  20 | await signupPage.enterAddress1();
  21 | await signupPage.enterState();
  22 | await signupPage.enterCity();
  23 | await signupPage.enterZipcode();
  24 | await signupPage.clickCreateAccount();
  25 | expect (signupPage.getHeadingAccountCreated).toBe("Account Created!");
  26 | 
  27 | })
```